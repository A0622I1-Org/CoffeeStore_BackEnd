...
INSERT INTO `a0622i1_coffee`.`material_cost` (`id`,`name`, `unit`, `description`, `quantity`, `unit_price`, `date`) VALUES ('1','Đường','gr','no description', '1000', '0.25', '2024-03-24 16:35:00');
INSERT INTO `a0622i1_coffee`.`material_cost` (`id`,`name`, `unit`,  `description`, `quantity`, `unit_price`, `date`) VALUES ('2','Đường','gr','no description', '2000', '0.2', '2024-03-25 16:35:00');
INSERT INTO `a0622i1_coffee`.`material_cost` (`id`,`name`, `unit`,  `description`, `quantity`, `unit_price`, `date`) VALUES ('3','Sữa','ml','no description', '1000', '0.5', '2024-03-24 16:35:00');
INSERT INTO `a0622i1_coffee`.`material_cost` (`id`,`name`, `unit`,  `description`, `quantity`, `unit_price`, `date`) VALUES ('4','Sữa','ml','no description', '2000', '0.6', '2024-03-25 16:35:00');
INSERT INTO `a0622i1_coffee`.`material_cost` (`id`,`name`, `unit`,  `description`, `quantity`, `unit_price`, `date`) VALUES ('5','Cafe bột','gr','no description', '1000', '1.3', '2024-03-24 16:35:00');
INSERT INTO `a0622i1_coffee`.`material_cost` (`id`,`name`, `unit`,  `description`, `quantity`, `unit_price`, `date`) VALUES ('6','Cafe bột','gr','no description', '2000', '1.1', '2024-03-25 16:35:00');
